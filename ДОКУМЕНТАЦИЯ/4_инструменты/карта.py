...
ФАЙЛЫ  = {'calc': 'web/calc.html', 'report': 'web/report.html', 'index': 'web/index.html'}
...
if __name__ == '__main__':
    книга = openpyxl.load_workbook(os.path.join(КОРЕНЬ, 'Калькулятор_ставки_часа.xlsx'))
