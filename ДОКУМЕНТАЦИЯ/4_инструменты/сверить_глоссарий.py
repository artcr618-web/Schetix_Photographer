...
Справочник (web/части/таблицы_прототип.py) — единственный источник названий.
...
spec = importlib.util.spec_from_file_location('тп', корень + '/web/части/таблицы_прототип.py')
...
import openpyxl
кн = openpyxl.load_workbook(корень + '/Калькулятор_ставки_часа.xlsx', data_only=True)
