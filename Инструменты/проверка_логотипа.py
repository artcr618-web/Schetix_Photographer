...
# Корень проекта — на уровень выше папки инструментов; пути больше не зашиты
#абсолютной копией рабочей папки (прежний баг: '/home/user/web/...' не существовало).
_КОРЕНЬ = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
FILES = [os.path.join(_КОРЕНЬ, 'Веб', 'report.html'),
         os.path.join(_КОРЕНЬ, 'Веб', 'calc.html')]
RULES = [
