...
extra = [
 ...
 ('fund_year_model','Маржа','=revenue_target*effective_fund','₽/год','d.fundY'),
...
items = [
 ...
 ('Деньги','Маржинальная прибыль','Маржа','d.fundY','fund_year_model','₽/год'),
...
charts = [
 ('Желаемая ставка', [
  ...
  ('Маржинальная прибыль','Маржа','d.goalFund','fund_year_model','=fund_year_model',d['goalFund']),
 ...
 ('Текущая ставка', [
  ...
  ('Маржинальная прибыль','Маржа','d.currentFund','current_fund_model','=current_fund_model',d['currentFund']),
 ...
 ('Ставка в ноль', [
  ...
  ('Маржинальная прибыль','Маржа','0','0','=0',0),
