...
СЛОВА = {
    ...
    'Неэффективное рабочее время': 'неэффективн[а-яё]+[ ]+рабоч[а-яё]+[ ]+врем[а-яё]+',
    'Резерв времени на простой и форс-мажоры': 'форс-мажор[а-яё]*|прост(?:ой|ым|ых|ое|ые|ого|ому|ом|ая|ую|оя|ою)',
